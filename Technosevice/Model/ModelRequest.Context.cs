...
namespace Technosevice.Model
{
    ...
    public partial class DBConnectRequest : DbContext
    {
        ...
        public virtual ObjectResult<GetRequestName_Result> GetRequestName(string masterName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetRequestName_Result>("GetRequestName", masterNameParameter);
        }
    }
}
